<div class="vs jj ttm vl ou uf na" x-data="kanban">
    ...
    <div class="flex items-center fe pb-3">
        ...
        <div class="flex items-center">
            ...
            <!-- Delete button -->
            <div class="flex items-center gq xm ml-1 text-red-400" wire:click="removeBoardId({{ $boardID }})">
                <svg class="os sf du" viewBox="0 0 32 32">
        ...
        <div class="tz _c tnu bd bg-gray-50  rounded overflow-y-auto overflow-x-hidden border border-gray-300">
            ...
            <div class="px-3 py-4">
                <div class="flex items-center fe ru">
                    <h2 class="uw gh text-slate-800 ld">{{ $section->title }}</h2>
                    <div class="ub text-indigo-500 xh nq cursor-pointer" wire:click="showCreateTaskModal">
