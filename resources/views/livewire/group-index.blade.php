<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Group ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Group</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Groups <span class="gq gp"></span></h2>
        </header>
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp cursor-pointer text-indigo-400 hover:text-indigo-500" wire:click="showDetailModal(1)">Born Pink</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp cursor-pointer text-indigo-400 hover:text-indigo-500" wire:click="showDetailModal({{ $group->id }})">{{ $group->name }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                            ...
                            <td class="vi wy w_ vo lm">
                                @if ($group->status === 'inactive')
                                    <div class="inline-flex gp hf yl rounded-full gn vp vd">{{ $group->status }}</div>
                                @endif 

                                @if ($group->status === 'active')
                                    <div class="inline-flex gp hc ys rounded-full gn vp vd">{{ $group->status }}</div>
                                @endif 
                            </td>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $group->id }})">
                                    <span class=" d">Edit</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M19.7 8.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM12.6 22H10v-2.6l6-6 2.6 2.6-6 6zm7.4-7.4L17.4 12l1.6-1.6 2.6 2.6-1.6 1.6z"></path>
                                        </svg>
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $group->id }})">
                                    <span class=" d">Delete</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M13 15h2v6h-2zM17 15h2v6h-2z"></path>
                                            <path d="M20 9c0-.6-.4-1-1-1h-6c-.6 0-1 .4-1 1v2H8v2h1v10c0 .6.4 1 1 1h12c.6 0 1-.4 1-1V13h1v-2h-4V9zm-6 1h4v1h-4v-1zm7 3v9H11v-9h10z"></path>
    ...
    <x-jet-dialog-modal wire:model="showGroupModal" class="">

        @if ($groupId)
        <x-slot name="title" class="border-b">Update Group</x-slot>
        @else
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input wire:model="files" type="file" multiple autocomplete="given-name"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select wire:model="groupStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-m-button wire:click="closeGroupModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
                    @if ($groupId)
    ...
    <!-- modal detail -->
    <x-jet-dialog-modal wire:model="showGroupDetailModal" class="">
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Detail Group</span>
        </x-slot>
        <x-slot name="content">
            <div class="border-t">
                <div class="vc vu ">
                    <div class="fw">
                        ...
                        <div class="je items-center2 vh">
                            ...
                            <div class="uw">
                                ...
                                Born Pink is the second studio group by South Korean girl group Blackpink, released on September 16, 2022, through YG Entertainment and Interscope Records. It marked the group's first full-length record since The Group in 2020. Production of the group was handled by various producers including Teddy Sinclair, Willy Sinclair, Bekuh Boom, R. Tee, Kush and Teddy Park. Blackpink conceived Born Pink as "the essence" of the group, taking inspiration from hip-hop sound throughout the group and combining various genres.
                                Born Pink's English-heavy sound draws mostly from pop, hip-hop, rock and EDM, with melodies characterized by more uptempo production than in its predecessor The Group. The songs incorporate eclectic styles ranging from disco and bubblegum pop to pop-rock and stadium rock. Lyrically, the group discusses themes of love, self-confidence, self-encouragement, dealing with fame and detractors, and more. Blackpink members Jisoo and Rosé co-wrote the fourth track "Yeah Yeah Yeah".
                                </div>
                                <!-- Product meta -->
