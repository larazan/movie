<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Album ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Album</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Albums <span class="gq gp"></span></h2>
        </header>
                ...
                <table class="ux ou">
                    ...
                    <thead class="go gh gv text-slate-500 hp co cs border-slate-200">
                        <tr>
                            ...
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Group/Actress</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp cursor-pointer text-indigo-400 hover:text-indigo-500" wire:click="showDetailModal({{ $album->id }})">{{ $album->name }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $album->person_id }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $album->year }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $album->country }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm">
                                <div>{{ $album->created_at->format('d-m-Y') }}</div>
                            </td>
    ...
    <x-jet-dialog-modal wire:model="showAlbumModal" class="">

        @if ($albumId)
        <x-slot name="title" class="border-b">Update Album</x-slot>
        @else
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-m-button wire:click="closeAlbumModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
                    @if ($albumId)
                    <x-m-button wire:click="updateAlbum" class=" ho xi ye">Update</x-m-button>
                    @else
                    <x-m-button wire:click="createAlbum" class=" ho xi ye2">Create</x-m-button>
                    @endif
                </div>
            </div>
    ...
    <!-- modal detail -->
    <x-jet-dialog-modal wire:model="showAlbumDetailModal" class="">
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Detail Album</span>
        </x-slot>
        <x-slot name="content">
            <div class="border-t">
                <div class="vc vu ">
