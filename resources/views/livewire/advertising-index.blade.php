<div class="vs jj ttm vl ou uf na">
    ...
    <x-jet-dialog-modal wire:model="showAdvertisingModal" class="">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-m-button wire:click="closeAdvertisingModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
                    @if ($advertisingId)
                    <x-m-button wire:click="updateAdvertising" class=" ho xi ye">Update</x-m-button>
                    @else
                    <x-m-button wire:click="createAdvertising" class=" ho xi ye2">Create</x-m-button>
                    @endif
                </div>
            </div>
