...
<section class="container mx-auto p-6 font-mono">
    <div class="w-full flex mb-4 p-2 justify-end">
        <x-jet-button wire:click="showCreateModal">Create Report</x-jet-button>
    </div>
...
<td class="px-4 py-3 text-ms font-semibold border">
    <img src="{{ asset('storage/'.$report->filename) }}" class="object-scale-down h-48 w-96" alt="{{ $report->name }}">
</td>

<td class="px-4 py-3 text-sm border">
    <x-m-button wire:click="showEditModal({{ $report->id }})" class="bg-green-500 hover:bg-green-700 text-white">Edit</x-m-button>
    <x-m-button wire:click="deleteReport({{ $report->id }})" class="bg-red-500 hover:bg-red-700 text-white">Delete</x-m-button>
</td>
</tr>
@endforeach
</tbody>
...
<x-jet-dialog-modal wire:model="showReportModal">
    @if ($reportId)
    <x-slot name="title">Update Report</x-slot>
    @else
    <x-slot name="title">Create Report</x-slot>
    @endif
    <x-slot name="content">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="flex flex-col space-y-4">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="photo" class="block text-sm font-medium text-gray-700">Report
                                        photo</label>
    ...
    <x-slot name="footer">
        <x-m-button wire:click="closeReportModal" class="bg-gray-600 hover:bg-gray-800 text-white">Cancel</x-m-button>
        @if ($reportId)
        <x-m-button wire:click="updateReport">Update</x-m-button>
        @else
        <x-m-button wire:click="createReport">Create</x-m-button>
        @endif
    </x-slot>
</x-jet-dialog-modal>
</section>
...
<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Report</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Reports <span class="gq gp"></span></h2>
        </header>
                ...
                <table class="ux ou">
                    ...
                    <thead class="go gh gv text-slate-500 hp co cs border-slate-200">
                        <tr>
                            ...
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Problem</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">User</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                                <div class="gh gt">Publish</div>
                            </th>
                            <th class="vi wy w_ vo lm">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">Code</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp cursor-pointer text-indigo-400 hover:text-indigo-500" wire:click="showDetailModal(1)">Problem</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gt capitalize">{{ $report->type }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gt capitalize">{{ $report->code }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp cursor-pointer text-indigo-400 hover:text-indigo-500" wire:click="showDetailModal({{ $report->id }})">{{ $report->problem }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="od sy ub mr-2 _b">
                                    <img src="{{ asset('images/avatar-03.jpg') }}" class="rounded-full" width="40" height="40" alt="{{ $report->id }}">
                                </div>
                            </td>

                            <td class="vi wy w_ vo lm">
                                @if ($report->publish === 0)
                                <div class="inline-flex gp hf yl rounded-full gn vp vd">Unpublish</div>
                                @endif

                                @if ($report->publish === 1)
                                <div class="inline-flex gp hc ys rounded-full gn vp vd">Publish</div>
                                @endif
                            </td>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $report->id }})">
                                        <span class=" d">Edit</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M19.7 8.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM12.6 22H10v-2.6l6-6 2.6 2.6-6 6zm7.4-7.4L17.4 12l1.6-1.6 2.6 2.6-1.6 1.6z"></path>
                                        </svg>
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $report->id }})">
                                        <span class=" d">Delete</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M13 15h2v6h-2zM17 15h2v6h-2z"></path>
                                            <path d="M20 9c0-.6-.4-1-1-1h-6c-.6 0-1 .4-1 1v2H8v2h1v10c0 .6.4 1 1 1h12c.6 0 1-.4 1-1V13h1v-2h-4V9zm-6 1h4v1h-4v-1zm7 3v9H11v-9h10z"></path>
    ...
    <x-jet-dialog-modal wire:model="showReportModal" class="">
        ...
        @if ($reportId)
        <x-slot name="title" class="border-b">Update Report</x-slot>
        @else
                ...
                <div class="vc vu ">
                    <div class="fw">
                        ...
                        <form>
                            ...
                            <input type="hidden" wire:model="$reportType" name="type" value="movie" />
                            <input type="hidden" wire:model="$reportCode" name="code" value="1" />
                            <div class="">
                                <div class="">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    ...
                    @if ($reportId)
                    <x-m-button wire:click="updateReport" class=" ho xi ye">Update</x-m-button>
                    @else
...
<!-- modal detail -->
<x-jet-dialog-modal wire:model="showReportDetailModal" class="">
    <x-slot name="title" class="border-b bg-slate-200">
        <span class="font-semibold">Detail Report</span>
    </x-slot>
    <x-slot name="content">
        <div class="border-t">
            <div class="vc vu ">
