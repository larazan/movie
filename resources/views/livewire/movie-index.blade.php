                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-start-1 sm:col-span-3">
                                            ...
                                            <input type="text" class="w-full px-4 py-6 text-sm border border-gray-300 rounded outline-none" name="tags" autofocus wire:model="movieTags" />
                                        </div>
                                        <div class="flex flex-row space-x-4 justify-between2">
                                            ...
                                            <div class="col-start-1 sm:col-span-3">
                                                <label for="rateType" class="block text-sm font-medium text-gray-700">
                                                    Rate Type
                                                </label>
                                                <select wire:model="rateType" class="h-full2 rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
                                        ...
                                        <div class="col-start-1 sm:col-span-3">
                                            ...
                                            <input wire:model="trailer" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="uw">
                               ...
                               @if (!empty($movieTags))
                                ...
                                <div>
                                    ...
                                    <livewire:report-modal :reportType="$reportType" :reportCode="29">
