<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc rc">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Shipments ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <!-- <button class="btn ho xi ye">
                ...
                <span class="hidden trm nq">Add Shipment</span>
            </button> -->
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">All Shipments <span class="gq gp">442</span></h2>
        </header>
                ...
                <table class="ux ou le lr">
                    ...
                    <tbody class="text-sm" x-data="{ open: false }">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="flex items-center text-slate-800">
                                    <a href="{{ url('admin/shipmentDetail/2') }}">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $shipment->order->code }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $shipment->status }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $shipment->total_qty }}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp ">{{ $shipment->total_weight }}</div>
                            </td>

                            <td class="vi wy w_ vo lm">
                                <div>{{ $shipment->order->order_date->format('d-m-Y') }}</div>
                            </td>

                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $shipment->id }})">
                                        <span class=" d">Edit</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M19.7 8.3c-.4-.4-1-.4-1.4 0l-10 10c-.2.2-.3.4-.3.7v4c0 .6.4 1 1 1h4c.3 0 .5-.1.7-.3l10-10c.4-.4.4-1 0-1.4l-4-4zM12.6 22H10v-2.6l6-6 2.6 2.6-6 6zm7.4-7.4L17.4 12l1.6-1.6 2.6 2.6-1.6 1.6z"></path>
                                        </svg>
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $shipment->id }})">
                                        <span class=" d">Delete</span>
                                        <svg class="os sf du" viewBox="0 0 32 32">
                                            <path d="M13 15h2v6h-2zM17 15h2v6h-2z"></path>
                                            <path d="M20 9c0-.6-.4-1-1-1h-6c-.6 0-1 .4-1 1v2H8v2h1v10c0 .6.4 1 1 1h12c.6 0 1-.4 1-1V13h1v-2h-4V9zm-6 1h4v1h-4v-1zm7 3v9H11v-9h10z"></path>
    ...
    <x-jet-dialog-modal wire:model="showShipmentModal" class="">

@if ($shipmentId)
<x-slot name="title" class="border-b">Update Shipment</x-slot>
@else
                            ...
                            <div class="flex flex-col space-y-3">
                                ...
                                <div class="flex flex-row justify-between">
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-0">
                                        ...
                                        <textarea wire:model="address1" name="description" id="description" cols="50" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >{{ $address1 }}</textarea>
                                    </div>
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-4">
                                        <label for="address2" class="block text-sm font-medium text-gray-700">
                                            Addrress 2
                                        </label>
                                        <textarea wire:model="address2" name="description" id="description" cols="50" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >{{ $address2 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row justify-between">
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-0">
                                        ...
                                        <input wire:model="company" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-4">
                                        <label for="postcode" class="block text-sm font-medium text-gray-700">
                                            Postcode
                                        </label>
                                        <input wire:model="postcode" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                </div>

                                <div class="flex flex-row justify-between">
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-0">
                                        <label for="provinceId" class="block text-sm font-medium text-gray-700">
                                            Province
                                        </label>
                                        <input wire:model="provinceId" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-4">
                                        <label for="cityId" class="block text-sm font-medium text-gray-700">
                                            City
                                        </label>
                                        <input wire:model="cityId" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row justify-between">
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-0">
                                        <label for="totalQty" class="block text-sm font-medium text-gray-700">
                                            Quantity
                                        </label>
                                        <input wire:model="totalQty" type="number" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                    <div class="col-start-1 sm:col-span-3 w-1/2 ml-4">
                                        <label for="totalWeight" class="block text-sm font-medium text-gray-700">
                                        Total Weight (gram)
                                        </label>
                                        <input wire:model="totalWeight" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                </div>
                                <div class="col-start-1 sm:col-span-3">
                                    <label for="trackNumber" class="block text-sm font-medium text-gray-700">
                                        Track Number
                                    </label>
                                    <input wire:model="trackNumber" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                </div>
                               {{-- 
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name" class="block text-sm font-medium text-gray-700">Status</label>
                                    <select wire:model="shipmentStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
...
<x-slot name="footer">
    <div class="border-slate-200">
        <div class="flex flex-wrap justify-end fc">
            <x-m-button wire:click="closeShipmentModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
            @if ($shipmentId)
            <x-m-button wire:click="updateShipment" class=" ho xi ye">Update</x-m-button>
            @else
            <x-m-button wire:click="createShipment" class=" ho xi ye2">Create</x-m-button>
            @endif
        </div>
    </div>
    ...
    <!-- modal detail -->
    <x-jet-dialog-modal wire:model="showShipmentDetailModal" class="">

        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Detail Shipment</span>
        </x-slot>
