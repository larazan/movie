<div class="vs jj ttm vl tet2 ou uf na">
...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Character ✨</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Character</span>
            </button>
        </div>
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left side -->
        <div class="ri _y">
            <button class="btn bg-red-400 ye" wire:click="backMovies">
                <!-- <svg class="oo sl du bf ub" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                </svg> -->
    ...
    <div class="tnp">
        ...
        <div class="q_ ug">
            ...
            <!-- Middle content -->
            <div class="ug qb tnf 2xl:mx-8 w-3/4">
                <div class="ter2">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $character->name }}</div>
                            </td>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $character->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteId({{ $character->id }})">
    ...
    <x-jet-dialog-modal wire:model="showCharacterModal" class="">

        @if ($characterId)
        <x-slot name="title" class="border-b">Update Character</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Character</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select wire:model="characterStatus" class="h-full rounded-r border-t border-r border-b block appearance-none w-full bg-white border-gray-300 text-gray-700 py-2 px-4 pr-8 leading-tight focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none">
                                                <option value="" >Select Option</option>
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-m-button wire:click="closeCharacterModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-m-button>
                    @if ($characterId)
                    <x-m-button wire:click="updateCharacter" class=" ho xi ye">Update</x-m-button>
                    @else
                    <x-m-button wire:click="createCharacter" class=" ho xi ye2">Create</x-m-button>
                    @endif
                </div>
            </div>
