    ...
    <div class="w-full flex space-x-3">
                            ...
                            <div class="">
                                <div class="flex flex-col space-y-3">
                                    ...
                                    <div class="col-start-1 sm:col-span-3">
                                        ...
                                        <input wire:model="name" type="text" autocomplete="given-name" class="s ou" />
                                    </div>
        ...
        <div class="w-full">
            ...
            <div class="bg-white bd rounded-sm border border-slate-200 rc">
                <header class="vc vu">
                    <h2 class="gh text-slate-800">Attributes For<span class="gq gp"></span></h2>
                    {{--
