                                        ...
                                        <ul class="rh">
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded hl" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-01.jpg" width="32" height="32" alt="User 01">
                                                        <div class="ld">
                                            ...
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-02.jpg" width="32" height="32" alt="User 02">
                                                        <div class="ld">
                                            ...
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-03.jpg" width="32" height="32" alt="User 03">
                                                        <div class="ld">
                                                            <span class="text-sm gp text-slate-800">Jerzy Wierzy</span>
                                                        </div>
                                                    </div>
                                                    <div class="flex items-center nq">
                                                        <img class="ox su rounded-full ub" src="./images/user-32-03.jpg" width="20" height="20" alt="User 03">
                                                    </div>
                                                </button>
                                            </li>
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-04.jpg" width="32" height="32" alt="User 04">
                                                        <div class="ld">
                                            ...
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-05.jpg" width="32" height="32" alt="User 05">
                                                        <div class="ld">
                                            ...
                                            <li class="nv">
                                                <button class="flex items-center fe ou dx rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                                    <div class="flex items-center ld">
                                                        <img class="os sf rounded-full mr-2" src="./images/user-32-06.jpg" width="32" height="32" alt="User 06">
                                                        <div class="ld">
