            ...
            <div>
                ...
                <ul class="nk">
                    ...
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['movies', 'movie-category', 'genres', 'countries', 'rate-types', 'networks', 'casts'])){{ 'bg-slate-900' }}@else{{ '' }}@endif" x-data="{ open: false }">
                        ...
                        <div class="tex ttj 2xl:block">
                            <ul class="me re @if(!in_array(Request::segment(2), ['movies', 'movie-category', 'genres', 'countries', 'rate-types', 'networks', 'casts'])){{ 'hidden' }}@else{ !block }@endif" :class="open ? '!block' : 'hidden'">
                                <li class="rt ww">
                                ...
                                <li class="rt ww">
                                    <a class="block @if(in_array(Request::segment(2), ['rate-types'])){{ 'text-indigo-500' }}@else{{ 'gq hover--text-slate-200' }}@endif wt wi ld" href="{{ url('admin/rate-types') }}">
                                        <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Rate Type</span>
                                    </a>
                                </li>
                                <li class="rt ww">
                    ...
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['persons', 'nationalities'])){{ 'bg-slate-900' }}@else{{ '' }}@endif" x-data="{ open: false }">
                        <a class="block gj xc ld wt wi" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center fe">
                                <div class="flex items-center">
                                    <svg class="ub so oi" viewBox="0 0 24 24">
                                        <path class="du @if(in_array(Request::segment(2), ['persons', 'nationalities'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"></path>
                                        <path class="du @if(in_array(Request::segment(2), ['persons', 'nationalities'])){{ 'text-indigo-300' }}@else{{ 'gq' }}@endif" d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z"></path>
                                    </svg>
                                    <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Person</span>
                                </div>
                                <!-- Icon -->
                        ...
                        <div class="tex ttj 2xl:block">
                            <ul class="me re @if(!in_array(Request::segment(2), ['persons', 'nationalities'])){{ 'hidden' }}@else{ !block }@endif" :class="open ? '!block' : 'hidden'">
                                <li class="rt ww">
                                    <a class="block @if(in_array(Request::segment(2), ['persons'])){{ 'text-indigo-500' }}@else{{ 'gq hover--text-slate-200' }}@endif wt wi ld" href="{{ url('admin/persons') }}">
                                        <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Person</span>
                                    </a>
                                </li>
                                <li class="rt ww">
                                    <a class="block @if(in_array(Request::segment(2), ['nationalities'])){{ 'text-indigo-500' }}@else{{ 'gq hover--text-slate-200' }}@endif wt wi ld" href="{{ url('admin/nationalities') }}">
                                        <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Nationality</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['adv-segments', 'advertisings'])){{ 'bg-slate-900' }}@else{{ '' }}@endif" x-data="{ open: false }">
                        <a class="block gj xc ld wt wi" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center fe">
                                <div class="flex items-center">
                                    <svg class="ub so oi" viewBox="0 0 24 24">
                                        <path class="du @if(in_array(Request::segment(2), ['adv-segments', 'advertisings'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"></path>
                                        <path class="du @if(in_array(Request::segment(2), ['adv-segments', 'advertisings'])){{ 'text-indigo-300' }}@else{{ 'gq' }}@endif" d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z"></path>
                                    </svg>
                     ...
                     <!-- Festival -->
                     <li class="vn vr rounded-sm n_ ww @if(in_array(Request::segment(2), ['festivals'])){{ 'bg-slate-900' }}@else{{ '' }}@endif">
                        <a class="block gj xc ld wt wi" href="{{ url('admin/festivals') }}">
                            <div class="flex items-center">
                                <svg class="ub so oi" viewBox="0 0 24 24">
                                    <path class="du @if(in_array(Request::segment(2), ['festivals'])){{ 'text-indigo-500' }}@else{{ 'g_' }}@endif" d="M1 3h22v20H1z"></path>
                                    <path class="du @if(in_array(Request::segment(2), ['festivals'])){{ 'text-indigo-300' }}@else{{ 'gq' }}@endif" d="M21 3h2v4H1V3h2V1h4v2h10V1h4v2Z"></path>
                                </svg>
                                <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Festival</span>
                            </div>
                        </a>
                    </li>
                    <!-- Messages -->
