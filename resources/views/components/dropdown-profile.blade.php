...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <div class="flex items-center truncate">
            <span class="truncate ml-2 text-sm font-medium group-hover:text-slate-800">{{ Auth::user()->first_name }}</span>
    ...
    >
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
            <div class="font-medium text-slate-800">{{ Auth::user()->first_name }}</div>
